...
<ul id="users-tab" class="tab-pane fade in active">
    <li>
        <img src="<?php echo Yii::app()->request->baseUrl ?>/assets/admin/images/peter-avatar.jpg" class="w35" alt>
    ...
    <li>
        <img src="<?php echo Yii::app()->request->baseUrl ?>/assets/admin/images/arnold-avatar.jpg" class="w35" alt>
    ...
    <li>
        <img src="<?php echo Yii::app()->request->baseUrl ?>/assets/admin/images/ici-avatar.jpg" class="w35" alt>
...
<ul id="orders-tab" class="tab-pane fade">
    ...
    <li>
        <img src="<?php echo Yii::app()->request->baseUrl ?>/assets/admin/images/george-avatar.jpg" class="w35" alt>
...
<ul id="messages-tab" class="tab-pane fade">
    <li>
        <img src="<?php echo Yii::app()->request->baseUrl ?>/assets/admin/images/profile-photo.jpg" class="w35" alt>
